...
import com.indialone.viewpager2andfragmentswithtablayout.databinding.FragmentTopHeadlinesBinding
...
class TopHeadlinesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        newsViewModel.getTopHeadlines().observe(viewLifecycleOwner) { newsEntity ->
            binding.rvTopHeadlines.layoutManager = LinearLayoutManager(context)
            binding.rvTopHeadlines.adapter =
